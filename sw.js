const CACHE='gunpo-eunhye-family-v7.4.0';
const ASSETS=['./','./index.html','./data.js','./service-data.js','./office-data.js','./manifest.webmanifest','./logo.png','./icon-192.png','./icon-512.png'];
