const CACHE='gunpo-eunhye-family-v6.2.0';
const ASSETS=['./','./index.html','./data.js','./service-data.js','./manifest.webmanifest','./logo.png','./icon-192.png','./icon-512.png','./공지사항.xlsx','./교회일정.xlsx'];
